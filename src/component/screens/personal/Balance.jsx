      ...
      <Top>
        <TopLeft>
          ...
          <h1 style={{ fontWeight: '700' }}>
            ¥ {state.balance + state.positionProfit}
          </h1>
        </TopLeft>
        <TopRight>
          <h2>Today Profit and Loss</h2>
          <h1 style={{ float: 'right', fontWeight: '700' }} id="balance">
            0.00
          </h1>
        </TopRight>
      </Top>
      <Bottom>
        ...
        <BottomMiddle>
          ...
          <h3
            style={{
              fontWeight: '700',
              color: state.positionProfit > 0 ? 'red' : 'green'
            }}
          >
            {state.positionProfit}
          </h3>
        </BottomMiddle>
        <BottomRight>
